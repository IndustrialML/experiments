...
def init():
    ...
    # load the model file
    global model
    model = joblib.load('model_50.pkl')
    inputs_dc = ModelDataCollector("model_50.pkl", identifier="inputs")
    prediction_dc = ModelDataCollector("model_50.pkl", identifier="prediction")
